...
export const projects: Project[] = [
  {
    ...
    tags: ["Next.js", "TypeScript", "AI", "Tailwind CSS", "Stripe", "Prisma"],
  ...
  },
  {
    ...
    longDescription:
      "Cockpit is a new-tab dashboard designed to support daily wellness and productivity. It combines a your bookmarks, habit tracker, meditation tools, and an AI goal-stoker into a calm, simple interface. A built-in XP and leveling system gamifies personal growth across wellbeing, productivity, and self-improvement tabs. The dashboard features rotating nature backgrounds that change with the day, customizable layouts, and a minimalist card-based UI. Built for focus and intention.",
    category: "Product",
  ...
  },
  {
    ...
    category: "CLI",
    image: "/images/projects/lethe.png",
